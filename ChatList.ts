let ChatList = {
    Greeting: [
        ...
        "If I'm too hungry I will die, so please feed me whenever I'm hungry!",
        "Aaaand that's all about myself. We'll gonna have a lot of fun together!"
    ],
    Chitchat: {
        happy: [
        ...
        neutral: [
            ...
            "Lemme see if I got something that I can play with... nope.",
            "Lemme get myself a book because I'm bored right now",
            "\'Behold, of my mighty nemesis!\'",
            "...",
    ...
    WantToPlay: {
        ...
        accept: "You sure? Well, you'd better prepared to be beaten!",
    ...
    Fall: [
        ...
        "Don't drop me!",
        "Don't drop me! I ain't got wings."
        ],
    TicTacToe: {
        winning: {
            happy: [
        ...
        losing_tie: {
            ...
            angry: [
                ...
                "You cheating?",
                "Come on it's just a game! Don't be that serious!",
    ...
    OnSound: ["Is that you making the noise?", "Woah... You scared me.", "I heard something loud.", "Is that an explosion?"]
}
